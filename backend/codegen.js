...
Generate clean, working code that can be executed immediately.`;
  ...
  throw new Error(
    `Failed to extract code after ${maxRetries} attempts. Last response: ${lastResponse}`
  );
}
...
export async function testCodeGen() {
  ...
  const tests = [
    ...
    },
    {
      ...
      prompt:
        'Generate code that creates an array of numbers 1-10, filters even numbers, and sums them',
    },
    {
      name: 'String Manipulation',
      prompt:
        'Write code that takes the string "hello world" and returns it reversed and capitalized',
    },
    {
      name: 'Data Structure',
