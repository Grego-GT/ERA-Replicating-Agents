...
export const getStyles = () => `
  ...
  textarea {
    @apply w-full mb-2 py-2 px-4 bg-gray-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm;
  }
  button {
  ...
  .tool-header {
    @apply w-full p-4 flex flex-row items-center gap-3 hover:bg-gray-50 transition-colors cursor-pointer border-none text-left text-text;
  }
  .tool-header-static {
